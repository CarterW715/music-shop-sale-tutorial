...
create table bad.shop_return
(
    shop_return_id serial primary key,
    shop_sale_id   integer     not null references bad.shop_sale,
...
create table bad.lesson_cancel
(
    lesson_cncl_id serial primary key,
    shop_lesson_id integer     not null references bad.shop_lesson,
    rfnd_amt       decimal     not null,
    msg_id         uuid        not null,
    evnt_ts        timestamp   not null,
    msg_version    varchar(12) not null
...
create table bad.sale_warranty
(
