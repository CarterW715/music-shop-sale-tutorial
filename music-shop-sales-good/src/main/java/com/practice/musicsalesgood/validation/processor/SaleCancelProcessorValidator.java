...
@AllArgsConstructor
public class SaleCancelProcessorValidator extends ProcessorValidator {
    ...
    public void validationLogic(MusicShopEvent event, List<String> errorList) {
        ...
        if (findLesson) {
            shopReturnCancelRepositoryImpl
                    .getReturnBySaleId(cancel.getLessonId())
                    .ifPresentOrElse(
                            shopReturn -> errorList.add("A cancellation with this lesson id has already been recorded"),
